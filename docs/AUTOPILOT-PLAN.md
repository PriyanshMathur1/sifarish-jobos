...
2. Form adapters for Greenhouse, Lever, Ashby hosted forms: field discovery by label and autocomplete attributes, resume upload, EEO sections left blank unless he opts in, custom questions routed to AnswerBank.
